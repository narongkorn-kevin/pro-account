...
import { AssetType, BranchPagination, DataBranch } from '../check-status.types';
...
export class CheckStatusPageComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(
        ...
        private _Service: CheckStatusService,
