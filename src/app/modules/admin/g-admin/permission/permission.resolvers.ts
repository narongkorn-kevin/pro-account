...
// import { PermissionService } from 'app/modules/admin/marketing/brief-plan/brief-plan.service';
import { AssetCategory } from 'app/shared/asset-category';
import { PermissionService, } from './permission.service';
import { AssetType, Chat, Division, PermissionPagination, PermissionProduct, PermissionProductDetail, Store, StoreType } from './permission.types';
...
export class PermissionProductResolver implements Resolve<any>
{
     ...
     * @param state
     */
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<PermissionProductDetail> {
...
export class PermissionProductsOsmResolver implements Resolve<any>
{
     ...
     * @param state
     */
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<{ meta: PermissionPagination; data: PermissionProduct[] }> {
