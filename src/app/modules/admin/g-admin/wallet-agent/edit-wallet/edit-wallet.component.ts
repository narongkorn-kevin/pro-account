...
import { AssetType, BankPagination } from '../wallet.types';
...
export class EditWalletComponent implements OnInit, AfterViewInit, OnDestroy {
...
export { BankPagination, AssetType };
