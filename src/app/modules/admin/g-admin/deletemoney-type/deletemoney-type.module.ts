...
import { DeletemoneyRoute } from './deletemoney-type.routing';
...
@NgModule({
  declarations: [
    ...
    ListComponent,
    NewDeletemoneyComponent,
    EditDeletemoneyComponent,
    DeletemoneyComponent

  ],
  imports: [
    RouterModule.forChild(DeletemoneyRoute),
    MatButtonModule,
    MatCheckboxModule,
    MatFormFieldModule,
    MatIconModule,
