...
import { AssetType, BranchPagination, DataWarehouse } from '../workads.types';
...
export class ListComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    loadTable(): void {
        ...
        this.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                ...
                that._Service
                    .getAdsWork(dataTablesParameters)
                    .subscribe((resp) => {
    ...
    Delete(id) {
        const confirmation = this._fuseConfirmationService.open({
            title: 'ลบบันทึกการทำงาน',
            message: 'คุณต้องการลบบันทึกการทำงานใช่หรือไม่ ?',
            icon: {
                show: true,
