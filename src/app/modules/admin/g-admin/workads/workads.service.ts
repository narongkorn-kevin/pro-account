...
export class WorkadsService {
  ...
  */
    ...
    ///create branch////
    newWorkads(data: any): Observable<any> {
        return this._httpClient.post(environment.API_URL + 'api/work_ads', data, this.httpOptionsFormdata).pipe(
            switchMap((response: any) => {
                return of(response);
            })
        );
    ...
    getAdsWork(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient.post(environment.API_URL + 'api/work_ads_page', dataTablesParameters, this.httpOptionsFormdata).pipe(
            switchMap((response: any) => {
    ...
    getAdsWorkById(dataId: any): Observable<any []> {
        return this._httpClient.get(environment.API_URL + 'api/work_ads/' + dataId, this.httpOptionsFormdata).pipe(
            switchMap((response: any) => {
                return of(response);
            })
        );
    ...
    AddAdsWorkById(dataId: any): Observable<any []> {
        return this._httpClient.post(environment.API_URL + 'api/work_ads', dataId, this.httpOptionsFormdata).pipe(
            switchMap((response: any) => {
                return of(response.data);
            })
        );
    ...
    deleteAdsWork(itemId: number): Observable<{}> {
        return this._httpClient
            .delete<any>(`${environment.API_URL}api/work_ads/${itemId}`, this.httpOptionsFormdata)
            .pipe(
                map((mtplan) => {
                    return mtplan;
                }),
