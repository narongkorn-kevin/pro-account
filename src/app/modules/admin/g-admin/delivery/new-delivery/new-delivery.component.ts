...
export class NewDeliveryComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(
        ...
        public dailogRef: MatDialogRef<NewDeliveryComponent>,
    ...
    New(): void {
        ...
        const confirmation = this._fuseConfirmationService.open({
            "title": "สร้างช่องทางการส่งของใหม่",
            "message": "คุณต้องการสร้างช่องทางการส่งของใหม่ใช่หรือไม่ ?",
            "icon": {
                "show": true,
        ...
        confirmation.afterClosed().subscribe((result) => {
            ...
            if (result === 'confirmed') {
                ...
                this._Service.newdelivery(formData).subscribe({
                    next: (resp: any) => {
