...
export class EditVendorComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this._Service.getVendorById(this._data.itemid).subscribe((resp: any) => {
            ...
            this.formData.patchValue({
                ...
                address: this.branchData.address ? this.branchData.address : '',
    ...
    Update(): void {
        ...
        confirmation.afterClosed().subscribe((result) => {
            ...
            if (result === 'confirmed') {
                ...
                this._Service.updateVendor(this.formData.value, this._data.itemid).subscribe((res: any) => {
