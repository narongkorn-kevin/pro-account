...
export class SaleOrderService {
  ...
  */
    ...
    */
    ...
    createTrack(itemtype: any): Observable<any> {
        return this._httpClient.post(environment.API_URL + 'api/SaleOrderTrack', itemtype, this.httpOptionsFormdata).pipe(
      ...
      itemReturn(itemtype: any): Observable<any> {
  ...
  */
    ...
    getsaleorderSalePage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient.post(environment.API_URL + 'api/sale_pages_order', dataTablesParameters, this.httpOptionsFormdata).pipe(
            switchMap((response: any) => {
                return of(response.data);
            })
        );
    ...
    updateTracking(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient.post(environment.API_URL + 'api/SaleOrderTrack', dataTablesParameters, this.httpOptionsFormdata).pipe(
            switchMap((response: any) => {
                return of(response.data);
            })
        );
