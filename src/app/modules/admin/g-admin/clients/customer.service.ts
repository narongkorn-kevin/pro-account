...
*/
  ...
  createCustomer(customerData: any): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/customer', customerData, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  updateCustomer(customer: any, customerId): Observable<any> {
    return this._httpClient.put(environment.API_URL + 'api/customer/' + customerId, customer, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getCustomerPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/customer_page', dataTablesParameters, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
