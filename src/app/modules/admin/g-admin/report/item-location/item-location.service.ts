...
export class StockItemService {
  ...
  */
    ...
    getReport(data: any): Observable<any> {
        return this._httpClient.post(environment.API_URL + 'api/report_stock_item', data, this.httpOptionsFormdata).pipe(
            switchMap((response: any) => {
                // Return a new observable with the response
                return of(response);
            })
    ...
    // getReportItemLocation(data: any): Observable<any> {
    //     return this._httpClient.post(environment.API_URL + 'api/report_stock_item', data, this.httpOptionsFormdata).pipe(
    //         switchMap((response: any) => {
    //             // Return a new observable with the response
    //             return of(response);
