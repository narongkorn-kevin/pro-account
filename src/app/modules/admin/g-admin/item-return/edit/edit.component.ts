...
export class EditComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit(): void {
        this._Service.getitemRetrunById(this._data.itemId).subscribe((resp: any) => {
            this.warehouseData = resp;
            console.log(this.warehouseData);
            this.formData.patchValue({
                order_id: this.warehouseData.order_id,
                // name: this.warehouseData.name,
                customer_phone: this.warehouseData.customer_phone,
