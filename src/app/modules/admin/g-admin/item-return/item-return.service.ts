...
export class ItemReturnService {
  ...
  */
    ...
    itemRetrunProduct(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient.post(environment.API_URL + 'api/item_return_page', dataTablesParameters, this.httpOptionsFormdata).pipe(
            switchMap((response: any) => {
                return of(response.data);
            })
        );
    ...
    AdditemRetrun(data: any): Observable<DataTablesResponse> {
        return this._httpClient.post(environment.API_URL + 'api/item_return', data, this.httpOptionsFormdata).pipe(
            switchMap((response: any) => {
                return of(response.data);
            })
        );
    ...
    getitemRetrunById(dataId: any): Observable<any[]> {
        return this._httpClient.get(environment.API_URL + 'api/item_return/' + dataId, this.httpOptionsFormdata).pipe(
            switchMap((response: any) => {
                return of(response.data);
            })
        );
    ...
    deleteitemRetrun(itemId: number): Observable<{}> {
        return this._httpClient
            .delete<any>(`${environment.API_URL}api/item_return/${itemId}`, this.httpOptionsFormdata)
            .pipe(
                map((mtplan) => {
                    return mtplan;
                }),
