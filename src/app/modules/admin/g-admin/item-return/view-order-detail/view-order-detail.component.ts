...
import { debounceTime, map, merge, Observable, Subject, switchMap, takeUntil, startWith } from 'rxjs';
...
import { AssetType, saleOrderPagination } from '../../sale-order/sale-order.types';
import { SaleOrderService } from '../../sale-order/sale-order.service';
import { AddtrackComponent } from '../../sale-order/add-track/add-track.component';
  ...
  ConfirmSaleOrder(): void {
      ...
      confirmation.afterClosed().subscribe((result) => {
          ...
          if (result === 'confirmed') {
              ...
              this._Service.confirmorder(this.saleorderId, 'confirm').subscribe({
                  next: (resp: any) => {
                      this._router.navigateByUrl('sale-order/list').then(() => { })
                  },
                  error: (err: any) => {
  ...
  Packing(): void {
      ...
      confirmation.afterClosed().subscribe((result) => {
          ...
          if (result === 'confirmed') {
              ...
              this._Service.confirmorder(this.saleorderId, 'packing').subscribe({
                  next: (resp: any) => {
                      this._router.navigateByUrl('sale-order/list').then(() => { })
                  },
                  error: (err: any) => {
  ...
  Delivery(): void {
      ...
      confirmation.afterClosed().subscribe((result) => {
          ...
          if (result === 'confirmed') {
              ...
              this._Service.confirmorder(this.saleorderId, 'delivery').subscribe({
                  next: (resp: any) => {
                      this._router.navigateByUrl('sale-order/list').then(() => { })
                  },
                  error: (err: any) => {
  ...
  Finish(): void {
      ...
      confirmation.afterClosed().subscribe((result) => {
          ...
          if (result === 'confirmed') {
              ...
              this._Service.confirmorder(this.saleorderId, 'finish').subscribe({
                  next: (resp: any) => {
                      this._router.navigateByUrl('sale-order/list').then(() => { })
                  },
                  error: (err: any) => {
  ...
  Failed(): void {
      ...
      confirmation.afterClosed().subscribe((result) => {
          ...
          if (result === 'confirmed') {
              ...
              this._Service.confirmorder(this.saleorderId, 'failed').subscribe({
                  next: (resp: any) => {
                      this._router.navigateByUrl('sale-order/list').then(() => { })
                  },
                  error: (err: any) => {
