...
import {
    ...
    salePagePagination, UserProduct, StoreType, AssetSize, Supplier, Division, DataSalePage
} from './sale-page.types';
...
export class SalePageService {
    // Private
    private _pagination: BehaviorSubject<salePagePagination | null> = new BehaviorSubject(null);
     ...
     */
    get pagination$(): Observable<salePagePagination> {
  ...
  */
    ...
    getProducts(page: number = 0,
        ...
        Observable<{ meta: salePagePagination; data: UserProduct[] }> {
        ...
        return this._httpClient.get<{ meta: salePagePagination; data: UserProduct[] }>(environment.API_URL + 'api/briefs', {
    ...
    getProductsND(page: number = 0,
        ...
        return this._httpClient.get<{ meta: salePagePagination; data: UserProduct[] }>(environment.API_URL + 'api/brief-osms', {
            params: searchParams, headers: new HttpHeaders({ Authorization: `Bearer ${token}` })
        }).pipe(
            tap((response) => {
                this._pagination.next({
  ...
  */
    ...
    getdelivery(): Observable<any> {
        return this._httpClient.get<any>(environment.API_URL + 'api/get_delivered_by').pipe(
            tap((user) => {
                this._materials.next(user);
            })
        );
    ...
    getchannel(): Observable<any> {
        return this._httpClient.get<any>(environment.API_URL + 'api/get_channels').pipe(
            tap((user) => {
                this._materials.next(user);
            })
        );
    ...
    createsalepage(salepage: any): Observable<any> {
        return this._httpClient.post(environment.API_URL + 'api/sale_pages', salepage, this.httpOptionsFormdata).pipe(
            switchMap((response: any) => {
                // Return a new observable with the response
                return of(response);
            })
...
updatesaleorder(saleorderId: any,saleorder: any) : Observable<any> {
  ...
  confirmorder(saleorderId : any,saleorder: any): Observable<any> {
    return this._httpClient.put(environment.API_URL + 'api/SaleOrder_status/' + saleorderId, {status: saleorder}, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getAll(dataTablesParameters: any): Observable<any> {
    return this._httpClient
      .post<any>(`${environment.API_URL}api/sale_page_product`, dataTablesParameters, this.httpOptionsFormdata)
      .pipe(
        map((resp: any) => {
          return resp;
        }));
