...
*/
  ...
  PaidSalary(dataForm: any): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/get_user_payroll_page', dataForm, this.httpOptionsFormdata).pipe(
        switchMap((response: any) => {
            // Return a new observable with the response
  ...
  getPaidSalaryPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/get_user_payroll_page', dataTablesParameters, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        return of(response.data);
      })
    );
  ...
  delete(itemId: number): Observable<{}> {
    return this._httpClient
      .delete<any>(`${environment.API_URL}api/item_type/${itemId}`, this.httpOptionsFormdata)
      .pipe(
        map((mtplan) => {
          return mtplan;
        }),
