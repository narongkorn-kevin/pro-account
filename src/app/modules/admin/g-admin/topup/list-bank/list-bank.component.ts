...
import { AssetType, BankPagination, DataBank } from '../bank.types';
...
export class ListBankComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    Edit(itemId: string) {
        const dialogRef = this._matDialog.open(EditBankComponent, {
            width: '900px',
            height: '950px',
            data: {
                itemid: itemId
    ...
    Confirm() {
        const dialogRef = this._matDialog.open(ConfirmPaymentComponent, {
            width: '900px',
            height: '750px'
        });
