...
export class WorkadminService {
  ...
  */
    ...
    getWorkAdminPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient.post(environment.API_URL + 'api/work_admin_page', dataTablesParameters, this.httpOptionsFormdata).pipe(
            switchMap((response: any) => {
                return of(response.data);
            })
        );
    ...
    newWork(dataForm: any): Observable<any> {
        return this._httpClient.post(environment.API_URL + 'api/work_admin', dataForm, this.httpOptionsFormdata).pipe(
            switchMap((response: any) => {
                // Return a new observable with the response
                return of(response);
            })
    ...
    getWorkById(dataId: any): Observable<any> {
        return this._httpClient.get(environment.API_URL + 'api/work_admin/' + dataId, this.httpOptionsFormdata).pipe(
            switchMap((response: any) => {
                // Return a new observable with the response
                return of(response);
            })
    ...
    deleteWork(itemId: number): Observable<{}> {
        return this._httpClient
            .delete<any>(`${environment.API_URL}api/work_admin/${itemId}`, this.httpOptionsFormdata)
            .pipe(
                map((mtplan) => {
                    return mtplan;
                }),
