...
*/
  ...
  createItemType(itemtype: any): Observable<any> {
    ...
    //     return throwError('User is already logged in.');
    // }
    return this._httpClient.post(environment.API_URL + 'api/income_paid', itemtype, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getType(): Observable<any[]> {
    return this._httpClient
        .get<any[]>(environment.API_URL + 'api/get_income_type')
        .pipe(
            tap((meterial) => {
                this._materials.next(meterial);
            })
...
getUser(): Observable<any[]> {
  ...
  getItemTypePage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/income_paid_page', dataTablesParameters, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
  ...
  delete(itemId: number): Observable<{}> {
    return this._httpClient
      .delete<any>(`${environment.API_URL}api/income_paid/${itemId}`, this.httpOptionsFormdata)
      .pipe(
        map((mtplan) => {
          return mtplan;
        }),
