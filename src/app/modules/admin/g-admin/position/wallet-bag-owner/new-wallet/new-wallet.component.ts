...
import { AssetType, BankPagination } from '../edit-wallet/edit-wallet.component';
...
export class NewWalletComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    New(): void {
        ...
        confirmation.afterClosed().subscribe((result) => {
            ...
            if (result === 'confirmed') {
                ...
                this._Service.newBank(formData).subscribe({
                    next: (resp: any) => {
