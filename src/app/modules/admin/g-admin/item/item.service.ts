...
*/
  ...
  NewItemSet(itemData): Observable<any> {
    return this._httpClient.post(environment.API_URL + 'api/item_add', itemData, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        // Return a new observable with the response
        return of(response);
      })
  ...
  getItemStock(dataTablesParameters: any): Observable<DataTablesResponse> {
