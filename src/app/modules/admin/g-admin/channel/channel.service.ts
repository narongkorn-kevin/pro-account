...
import {
  ...
  ChannelPagination, ChannelProduct, StoreType, AssetSize, Supplier, Division, DataChannel
} from './channel.types';
...
export class ChannelService {
  ...
  private _product: BehaviorSubject<ChannelProduct | null> = new BehaviorSubject(null);
  private _products: BehaviorSubject<ChannelProduct[] | null> = new BehaviorSubject(null);
  private _product_osm: BehaviorSubject<ChannelProduct | null> = new BehaviorSubject(null);
  private _products_osm: BehaviorSubject<ChannelProduct[] | null> = new BehaviorSubject(null);
   ...
   * Getter for product
   */
  get product$(): Observable<ChannelProduct> {
   ...
   * Getter for products
   */
  get products$(): Observable<ChannelProduct[]> {
   ...
   * Getter for product
   */
  get product_osm$(): Observable<ChannelProduct> {
...
*/
  ...
  getProducts(page: number = 0,
    ...
    Observable<{ meta: ChannelPagination; data: ChannelProduct[] }> {
    ...
    return this._httpClient.get<{ meta: ChannelPagination; data: ChannelProduct[] }>(environment.API_URL + 'api/briefs', {
  ...
  getProductsND(page: number = 0,
    ...
    return this._httpClient.get<{ meta: ChannelPagination; data: ChannelProduct[] }>(environment.API_URL + 'api/brief-osms', {
      params: searchParams, headers: new HttpHeaders({ Authorization: `Bearer ${token}` })
    }).pipe(
      tap((response) => {
        this._pagination.next({
  ...
  */
   ...
   * Create product
   */
  createProduct(): Observable<ChannelProduct> {
    return this.products$.pipe(
      take(1),
      switchMap(products => this._httpClient.post<ChannelProduct>('api/marketing/brief-plan/product', {}).pipe(
        map((newProduct) => {
   ...
   * @param product
   */
  updateProduct(id: string, product: ChannelProduct): Observable<ChannelProduct> {
    return this.products$.pipe(
      take(1),
      switchMap(products => this._httpClient.patch<ChannelProduct>('api/marketing/brief-plan/product', {
        id,
        product
      }).pipe(
        map((updatedProduct) => {
...
*/
  ...
  ///create branch////
  newchannel(data: FormData): Observable<DataChannel> {
    return this._httpClient.post<DataChannel>(environment.API_URL + 'api/channels', data, { headers: this.httpOptionsFormdata.headers });
  }


  updatechannel(data: FormData): Observable<DataChannel> {
    return this._httpClient.post<DataChannel>(environment.API_URL + 'api/up_channel', data, { headers: this.httpOptionsFormdata.headers });
  }
  // get Branch //
  ...
  getchannelbyId(channelId: string): Observable<any[]> {
    return this._httpClient.get<any[]>(environment.API_URL + 'api/channels/' + channelId).pipe(
      tap((meterial) => {
        this._materials.next(meterial);
      })
    );
  ...
  getchannelPage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/channels_page', dataTablesParameters, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
