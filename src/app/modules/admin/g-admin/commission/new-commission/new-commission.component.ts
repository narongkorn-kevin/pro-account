...
export class NewCommissionComponent implements OnInit, AfterViewInit, OnDestroy {
    formData: FormGroup
     ...
     */
    constructor(
        public dialogRef: MatDialogRef<NewCommissionComponent>,
