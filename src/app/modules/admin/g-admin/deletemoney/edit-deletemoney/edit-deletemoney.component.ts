...
import { AssetType, BranchPagination } from '../deletemoney.types';
import { DeletemoneyService } from '../deletemoney.service';
// import { ImportOSMComponent } from '../card/import-osm/import-osm.component';

@Component({
    selector: 'edit-deletemoney',
    templateUrl: './edit-deletemoney.component.html',
    styleUrls: ['./edit-deletemoney.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush
    // animations: fuseAnimations
})

export class EditDeletemoneyComponent implements OnInit, AfterViewInit, OnDestroy {
    itemtypeData: any;
    statusData = [
     ...
     */
    constructor(
        public dialogRef: MatDialogRef<EditDeletemoneyComponent>,
