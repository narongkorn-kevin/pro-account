...
export class DeletemoneyService {
  // Private
...
*/
  ...
  createItemType(itemtype: any): Observable<any> {
    ...
    return this._httpClient.post(environment.API_URL + 'api/deduct_paid', itemtype, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
        return of(response);
      })
    );
  ...
  getType(): Observable<any[]> {
    return this._httpClient
        .get<any[]>(environment.API_URL + 'api/get_deduct_type')
        .pipe(
            tap((meterial) => {
                this._materials.next(meterial);
            })
...
getUser(): Observable<any[]> {
  ...
  getItemTypePage(dataTablesParameters: any): Observable<DataTablesResponse> {
    return this._httpClient.post(environment.API_URL + 'api/deduct_paid_page', dataTablesParameters, this.httpOptionsFormdata).pipe(
      switchMap((response: any) => {
  ...
  delete(itemId: number): Observable<{}> {
    return this._httpClient
      .delete<any>(`${environment.API_URL}api/deduct_paid/${itemId}`, this.httpOptionsFormdata)
      .pipe(
        map((mtplan) => {
          return mtplan;
        }),
