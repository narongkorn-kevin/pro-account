...
@Component({
  selector: 'app-telesale-calendar',
  templateUrl: './telesale-calendar.component.html',
  styleUrls: ['./telesale-calendar.component.scss'],
  animations: fuseAnimations,
  // providers: [
  //     { provide: MAT_DATE_FORMATS, useValue: MY_DATE_FORMATS }
  // ]
})
export class TelesaleCalendarComponent implements OnInit {
  ...
  calendarOptionSale: CalendarOptions = {
      locale: 'th',
  ...
  ngOnInit(): void {
      this.clearForm();
      this.listPosition();
      this.calendarOptionSale.rerenderDelay = 3;
