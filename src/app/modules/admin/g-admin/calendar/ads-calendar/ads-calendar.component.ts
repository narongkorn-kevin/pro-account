...
@Component({
  selector: 'app-ads-calendar',
  templateUrl: './ads-calendar.component.html',
  styleUrls: ['./ads-calendar.component.scss'],
  animations: fuseAnimations,
  // providers: [
  //     { provide: MAT_DATE_FORMATS, useValue: MY_DATE_FORMATS }
  // ]
})
export class AdsCalendarComponent implements OnInit {
    events: any = [];
    files: File[] = [];
    formData: FormGroup
