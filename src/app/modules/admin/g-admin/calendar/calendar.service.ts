...
import {
    ...
    BankPagination, BankProduct, StoreType, AssetSize, Supplier, Division, DataBank
} from './calendar.types';
...
export class CalendarService {
    // Private
    private _pagination: BehaviorSubject<BankPagination | null> = new BehaviorSubject(null);
    private _product: BehaviorSubject<BankProduct | null> = new BehaviorSubject(null);
    private _products: BehaviorSubject<BankProduct[] | null> = new BehaviorSubject(null);
    private _product_osm: BehaviorSubject<BankProduct | null> = new BehaviorSubject(null);
    private _products_osm: BehaviorSubject<BankProduct[] | null> = new BehaviorSubject(null);
     ...
     */
    get pagination$(): Observable<BankPagination> {
     ...
     * Getter for product
     */
    get product$(): Observable<BankProduct> {
     ...
     * Getter for products
     */
    get products$(): Observable<BankProduct[]> {
     ...
     * Getter for product
     */
    get product_osm$(): Observable<BankProduct> {
  ...
  */
    ...
    getProducts(page: number = 0,
        ...
        Observable<{ meta: BankPagination; data: BankProduct[] }> {
        ...
        return this._httpClient.get<{ meta: BankPagination; data: BankProduct[] }>(environment.API_URL + 'api/briefs', {
    ...
    getProductsND(page: number = 0,
        ...
        return this._httpClient.get<{ meta: BankPagination; data: BankProduct[] }>(environment.API_URL + 'api/brief-osms', {
            params: searchParams, headers: new HttpHeaders({ Authorization: `Bearer ${token}` })
        }).pipe(
            tap((response) => {
                this._pagination.next({
    ...
    */
     ...
     * Create product
     */
    createProduct(): Observable<BankProduct> {
        return this.products$.pipe(
            take(1),
            switchMap(products => this._httpClient.post<BankProduct>('api/marketing/brief-plan/product', {}).pipe(
                map((newProduct) => {
     ...
     * @param product
     */
    updateProduct(id: string, product: BankProduct): Observable<BankProduct> {
        return this.products$.pipe(
            take(1),
            switchMap(products => this._httpClient.patch<BankProduct>('api/marketing/brief-plan/product', {
                id,
                product
            }).pipe(
                map((updatedProduct) => {
  ...
  */
    ...
    ///create branch////
    newBank(data: FormData): Observable<DataBank> {
        return this._httpClient.post<DataBank>(environment.API_URL + 'api/bank', data, { headers: this.httpOptionsFormdata.headers });
    }


    updateBank(data: FormData): Observable<DataBank> {
        return this._httpClient.post<DataBank>(environment.API_URL + 'api/reset_bank', data, { headers: this.httpOptionsFormdata.headers });
    }
    ...
    getbankPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient.post(environment.API_URL + 'api/bankPage_page', dataTablesParameters, this.httpOptionsFormdata).pipe(
            switchMap((response: any) => {
    ...
    getCalendar(dataBody: any): Observable<any> {
        return this._httpClient
            .post<any>(`${environment.API_URL}api/get_working_time`, dataBody, this.httpOptionsFormdata)
            .pipe(
                switchMap((response: any) => {
                    return of(response);
                })
    ...
    new(workingtime: any): Observable<any> {
        return this._httpClient.post(environment.API_URL + 'api/working_time', workingtime, this.httpOptionsFormdata).pipe(
            switchMap((response: any) => {
                // Return a new observable with the response
                return of(response);
            })
    ...
    update(workingtime: any): Observable<any> {
        return this._httpClient.post(environment.API_URL + 'api/working_time_type', workingtime, this.httpOptionsFormdata).pipe(
            switchMap((response: any) => {
                // Return a new observable with the response
                return of(response);
            })
    ...
    getbyId(id: string): Observable<any[]> {
        return this._httpClient.get<any[]>(environment.API_URL + 'api/working_time/' + id).pipe(
            tap((meterial) => {
                this._materials.next(meterial);
            })
        );
