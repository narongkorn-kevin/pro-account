...
export class ListSalePageFinishComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    loadTableTotal(): void {
        ...
        this.dtOptionsTotal = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                dataTablesParameters.type = 'SP';
                dataTablesParameters.status = null;
                that._Service.getsaleorderSalePage(dataTablesParameters).subscribe((resp) => {
