...
export class ViewSaleOrderFinishComponent
    implements OnInit, AfterViewInit, OnDestroy
{
    ...
    Addtrack() {
        const dialogRef = this._matDialog.open(AddtrackFinishComponent, {
            width: '700px',
            height: 'auto',
            data: {
                id: this.saleorderId
    ...
    itemReturn() {
        const dialogRef = this._matDialog.open(ItemReturnFinishComponent, {
            width: '700px',
            height: 'auto',
        });
