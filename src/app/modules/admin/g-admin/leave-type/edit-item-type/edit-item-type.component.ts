...
import { AssetType, BranchPagination } from '../leave-type.types';
import { ItemTypeService } from '../leave-type.service';
...
export class EditItemTypeComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    Edit(): void {
        ...
        const confirmation = this._fuseConfirmationService.open({
            "title": "ยืนยันแก้ไขประเภทสินค้าใหม่",
            "message": "คุณต้องการแก้ไขประเภทสินใหม่ใช่หรือไม่ ?",
            "icon": {
                "show": true,
    ...
    Update(): void {
        ...
        const confirmation = this._fuseConfirmationService.open({
            ...
            "message": "คุณต้องการแก้ไขประเภทการลาใช่หรือไม่ ",
            "icon": {
                "show": false,
                "name": "heroicons_outline:exclamation",
                "color": "warning"
