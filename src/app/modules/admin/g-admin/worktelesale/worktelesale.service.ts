...
export class WorktelesaleService {
    // Private
  ...
  */
    ...
    getCustomerTelePage(dataTablesParameters: any): Observable<DataTablesResponse> {
      ...
      updateCall(dataTablesParameters: any): Observable<any> {
        return this._httpClient.post(environment.API_URL + 'api/update_call', dataTablesParameters, this.httpOptionsFormdata).pipe(
          switchMap((response: any) => {
            return of(response.data);
          })
        );
    ...
    newFileAudio(data: any): Observable<any> {
        return this._httpClient.post(environment.API_URL + 'api/work_telesale', data, this.httpOptionsFormdata).pipe(
            switchMap((response: any) => {
                // Return a new observable with the response
                return of(response.data);
            })
    ...
    getWorkTeleById(data: any): Observable<any> {
        return this._httpClient.get<any[]>(environment.API_URL + 'api/work_telesale/' + data).pipe(
             switchMap((response: any) => {
            return of(response.data);
            })
        );
