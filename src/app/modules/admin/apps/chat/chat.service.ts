...
export class ChatService {
    ...
    getChatById(converId: string): Observable<any> {
        ...
        return this._httpClient.get<Chat>(`https://graph.facebook.com/v16.0/${converId}?fields=participants,messages{from,to,message,attachments}&access_token=${pageToken}`).pipe(
            map((chat) => {
