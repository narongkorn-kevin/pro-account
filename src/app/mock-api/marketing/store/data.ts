...
export const products = [
    {
        id: '1',
        asset_type: 'Price POP',
        season: '19FW',
        division: '1',
        item_code: '19W-PP-18-001',
        item_name: 'W s seamless V neck bra camiso',
        store_type: 'Large',
        effective_date: '01/03/22',
        expiry_date: '12/03/22',
        status: 'Availiable',
    ...
    },
    {
        ...
        expiry_date: '12/03/22',
        status: 'Availiable',
        thumbnail: 'assets/images/artworks/artwork-2.png',
        images: [
            'assets/images/artworks/artwork-2.png',
            'assets/images/artworks/artwork-2.png',
            'assets/images/artworks/artwork-2.png'
        ],
        active: true,
    },
    {
        ...
        expiry_date: '12/03/22',
        status: 'Availiable',
        thumbnail: 'assets/images/artworks/artwork-3.png',
        images: [
            'assets/images/artworks/artwork-3.png',
            'assets/images/artworks/artwork-3.png',
            'assets/images/artworks/artwork-3.png'
        ],
        active: true,
    },
    {
        ...
        expiry_date: '12/03/22',
        status: 'Availiable',
        thumbnail: 'assets/images/artworks/artwork-4.png',
        images: [
            'assets/images/artworks/artwork-4.png',
            'assets/images/artworks/artwork-4.png',
            'assets/images/artworks/artwork-4.png'
        ],
        active: true,
