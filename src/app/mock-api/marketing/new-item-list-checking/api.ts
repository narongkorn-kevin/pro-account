...
import { brands as brandsData, categories as categoriesData, products as productsData, tags as tagsData, vendors as vendorsData } from 'app/mock-api/marketing/new-item-list-checking/data';

@Injectable({
    providedIn: 'root'
})
export class NewItemListCheckingMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        this._fuseMockApiService
            .onGet('api/marketing/new-item-list-checking/categories')
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/marketing/new-item-list-checking/brands')
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/marketing/new-item-list-checking/products', 300)
            .reply(({request}) => {
                ...
                // Sort the products
                if ( sort === 'item_name' || sort === 'item_code' || sort === 'active' )
                {
                    products.sort((a, b) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/marketing/new-item-list-checking/product')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPost('api/marketing/new-item-list-checking/product')
            .reply(() => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPatch('api/marketing/new-item-list-checking/product')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onDelete('api/marketing/new-item-list-checking/product')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/marketing/new-item-list-checking/tags')
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPost('api/marketing/new-item-list-checking/tag')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPatch('api/marketing/new-item-list-checking/tag')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onDelete('api/marketing/new-item-list-checking/tag')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/marketing/new-item-list-checking/vendors')
